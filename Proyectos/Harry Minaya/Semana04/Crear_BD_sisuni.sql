...
COMMENT ON TABLE sisuni.Usuario IS 'Tabla de usuario.';




COMMENT ON COLUMN sisuni.Usuario.chr_emplcodigo IS 'Código del usuario.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplpaterno IS 'Apellido paterno.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplmaterno IS 'Apellido materno.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplnombre IS 'Nombre.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplciudad IS 'Ciudad.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplusuario IS 'Usuario.';




COMMENT ON COLUMN sisuni.Usuario.vch_empldireccion IS 'Dirección.';




COMMENT ON COLUMN sisuni.Usuario.vch_emplclave IS 'Clave.';
